...
public class SubCategoriesItemsAdapter extends RecyclerView.Adapter<SubCategoriesItemsAdapter.MyViewHolder> {
    ...
    public SubCategoriesItemsAdapter(List<ItemDetailsReponse> itemDetailsReponses, Context context , OnItemClickListener onItemClickListener ) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_get_item, parent, false);
