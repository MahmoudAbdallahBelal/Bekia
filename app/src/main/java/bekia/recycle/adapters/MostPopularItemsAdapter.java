...
public class MostPopularItemsAdapter extends RecyclerView.Adapter<MostPopularItemsAdapter.MyViewHolder> {
    ...
    public MostPopularItemsAdapter(List<ItemDetailsReponse> itemDetailsReponses, Context context , OnItemClickListener onItemClickListener ) {
